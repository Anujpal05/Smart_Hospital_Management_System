      ...
      <nav className="    ">
        <div className=" hidden lg:block">
          <div className=" bg-[#eef2ff]  h-16 flex items-center p-4">
            <h1 className="text-3xl font-bold text-blue-900 xl:pl-32 lg:pl-12">
              MED<span className=" text-blue-500">DICAL</span>
            </h1>
            <div className="flex justify-between gap-6 xl:gap-12 xl:ml-32 lg:ml-6 ">
        ...
        <div className=" lg:hidden flex justify-between items-center font-semibold px-4 py-4 text-gray-200 bg-blue-900 relative">
          <h1 className="text-xl font-bold text-blue-300">
            MED<span className=" text-white">DICAL</span>
          </h1>
          <div className=" flex items-center gap-6">
            ...
            <button
              className=" text-4xl text-white  outline-none cursor-pointer"
        ...
        {open && (
          <div className=" absolute top-16 left-0 w-full bg-blue-900 text-gray-200 flex flex-col items-center gap-4 py-4 lg:hidden z-20">
            ...
            <div>
              <button
                className=" bg-blue-300 text-blue-900 font-semibold px-4 py-2 rounded-full cursor-pointer outline-none"
                onClick={() => setOPen(!open)}
              >
