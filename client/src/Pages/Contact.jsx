  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full h-[250px]">
        ...
        />
        <div className="absolute inset-0 text-[#1F2B6C]  bg-gray-300/60 flex flex-col justify-center px-10">
      ...
      <div className=" py-16 px-6 md:px-20">
        <div className="grid grid-cols-2 gap-10">
          ...
          {/* ===== Contact Form ===== */}
          <div className="">
            <p className="text-[#159EEC] font-semibold text-sm">
              GET IN TOUCH
            </p>
            <h2 className="text-3xl text-[#1F2B6C] font-bold text-blue-900 mt-2 mb-6">
              Contact
            </h2>
          ...
          <div className="space-y-6 grid grid-cols-2 gap-4">
            ...
            {/* Emergency */}
            <div className="bg-blue-200 hover:bg-[#1F2B6C] hover:text-gray-200 cursor-pointer group text-gray-700 transition duration-300 h-48 p-6 rounded-lg shadow-md">
              <FaPhoneAlt className="text-blue-900 group-hover:text-gray-200 text-2xl mb-3" />
            ...
            <div className="bg-blue-200 hover:bg-[#1F2B6C] hover:text-gray-200 cursor-pointer group text-gray-700 transition duration-300 h-48 p-6 rounded-lg shadow-md">
              ...
              <h3 className="font-bold text-blue-900 group-hover:text-gray-200 mb-2">WORKING HOURS</h3>
