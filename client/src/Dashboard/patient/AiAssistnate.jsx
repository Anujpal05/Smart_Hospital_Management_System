...
const recentAssessments = [
  {
    ...
    result: "Musculoskeletal Strain",
    severity: "Mild",
    urgency: "GP Follow-up",
  },
  {
    id: 2,
    date: "Sep 12, 2023",
    ...
    severity: "Low",
    urgency: "OTC Medication",
  },
  {
    id: 3,
    date: "Aug 05, 2023",
    symptom: "Occasional Vertigo",
    result: "Inner Ear Imbalance",
    severity: "Moderate",
    urgency: "Specialist Visit",
  },
];
...
const AiAssistnate = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "ai",
      text: `Hello, ${patientData.name}! I analyzed your latest reports and vitals. How can I assist you with your health today?`,
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const aiResponse = await askGroq(history, currentInput);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Cross-referencing your medical history with latest clinical
            guidelines
          </p>
        </div>
        <div className="bg-amber-50 border border-amber-200 p-3 rounded-2xl flex items-start gap-3 max-w-sm">
          ...
          <p className="text-[10px] text-amber-800 leading-relaxed font-medium uppercase">
            Disclaimer: This is an AI analysis, not a medical diagnosis. Always
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between gap-6">
            <div className="max-w-md">
              ...
              <h3 className="text-2xl font-bold mb-3 leading-tight">
                Your Sleep-Heart Consistency
              </h3>
              <p className="text-blue-100/80 text-sm leading-relaxed mb-6">
                We've noticed your resting heart rate decreases significantly
                when you sleep before 10:30 PM. Maintaining this schedule could
                improve your cardiovascular recovery score by 15%.
              </p>
              <button
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <p className="text-xs font-bold text-slate-400 mb-1 uppercase">
                  Source Document
                </p>
                <p className="text-sm font-bold text-slate-800">
                  Blood Chemistry Profile (Oct 12)
                </p>
              </div>
              <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                ...
                <p className="text-sm text-slate-700 leading-relaxed">
                  Glucose, Lipid Profile, and Kidney Function markers are all
              ...
              <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100">
                ...
                <p className="text-sm text-slate-700 leading-relaxed">
                  Vitamin D (25-OH) is at 22 ng/mL (Target: 30+). Recommended
                  supplementation.
                </p>
              </div>
            </div>
        ...
        <div className="lg:col-span-2 flex flex-col h-[600px] bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  I can read your reports and answer medical queries
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-slate-50/20">
            {messages.map((msg) => (
              ...
              >
                ...
                <div
                  className={`p-2 px-4 rounded-2xl shadow-sm max-w-[85%] ${
                    msg.sender === "user"
          ...
          <div className="p-6 bg-white border-t border-slate-100">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {["Interpret Labs", "Compare Vitals", "Suggest Exercise"].map(
                (tag) => (
                  <button
                    key={tag}
